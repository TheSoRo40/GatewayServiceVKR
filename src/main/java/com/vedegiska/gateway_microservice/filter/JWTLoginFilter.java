...
public class JWTLoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    @Autowired
    public JWTLoginFilter(AuthenticationManager authenticationManager, ITokenAuthenticationService tokenAuthenticationService) {
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request,
        ...
        response.getWriter().write("Error. You are not authentication");
